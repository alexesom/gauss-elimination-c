...
public class CreateInsertionSortTables {
    @Test
    public void createOptimisticDataTable() {
        try (BufferedWriter fileWrite = new BufferedWriter(new FileWriter("testsData/InsertionSortOptimistic.txt"))) {
            int degreeOfTwo = 0;
    ...
    public void createPessimisticDataTable() {
        try (BufferedWriter fileWrite = new BufferedWriter(new FileWriter("testsData/InsertionSortPessimistic.txt"))) {
            int degreeOfTwo = 0;
    ...
    public void createRandomDataTable() {
        try (BufferedWriter fileWrite = new BufferedWriter(new FileWriter("testsData/InsertionSortRandom.txt"))) {
            int degreeOfTwo = 0;
            Random random = new Random(111);
